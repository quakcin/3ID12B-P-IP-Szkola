...
CREATE TABLE Frekwencja (
    ...
    UczenId NVARCHAR2(36) NOT NULL,
    LekcjaId NUMBER NOT NULL,
    Data DATE NOT NULL,
    CONSTRAINT Frekwencja_pk PRIMARY KEY (Id),
    CONSTRAINT Frekwencja_Uczen_fk FOREIGN KEY (UczenId) REFERENCES Uczen(Id) ON DELETE CASCADE,
    CONSTRAINT Frekwencja_Lekcja_fk FOREIGN KEY (LekcjaId) REFERENCES Lekcja(Id) ON DELETE CASCADE
);
