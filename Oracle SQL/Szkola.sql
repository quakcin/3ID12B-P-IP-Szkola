...
SELECT Klasa.Nazwa, COUNT(Uczen.Id) LiczbaUczniow, CONCAT(CONCAT(Nauczyciel.imie, ' '), Nauczyciel.nazwisko) AS Wychowawca 
FROM Klasa
INNER JOIN Nauczyciel ON Nauczyciel.KlasaId = Klasa.Nazwa
INNER JOIN Uczen ON Uczen.Klasa = Klasa.Nazwa
GROUP BY Klasa.Nazwa, CONCAT(CONCAT(Nauczyciel.imie, ' '), Nauczyciel.nazwisko)
